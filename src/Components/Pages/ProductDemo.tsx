...
<div className='bg-[#FFFFFF] flex justify-center items-start relative' >
            ...
            <iframe className="lg:w-[90vw] w-[80vw] lg:h-[60vh] h-full aspect-video " src="https://www.youtube.com/embed/siGCVexlDCY?si=xlmKB3TvICmAT8sy"></iframe>
          </div>
      ...
      <div className='bg-[#FFFFFF] sm:px-16 px-6 flex justify-center items-start' >
        <div className='xl:max-w-[1280px] w-full'>
          <section className='flex md:flex-row flex-col sm:py-16 py-6'>
            ...
            <div className="flex justify-center mt-8" >
            <iframe className="lg:w-[50vw] w-[80vw] h-full aspect-video " src="https://www.youtube.com/embed/ieJ2YTdEfBs?si=dVkXayVvcnH8xTWh"></iframe>
          </div>
            </div>

            <div className='flex-1 flex   flex-col md:ml-[120px] ml-0 md:mt-[110px] mt-5 relative'>
              <div className="md:flex flex-row   w-full">
                <h1 className="flex  font-poppins font-[900] md:text-[40px] text-[27px] text-black md:leading-[48px] leading-[38px]">
       ...
       <div className='bg-[#FFFFFF] sm:px-16 px-6 flex justify-center items-start md:pt-10' >
        <div className='xl:max-w-[1280px] w-full'>
          <section className='flex md:flex-row flex-col sm:py-16 py-6'>
            <div className='flex-1 flex-col justify-center items-start  '>
            <div className="flex justify-center mt-8" >
            <iframe className="lg:w-[50vw] w-[80vw] h-full aspect-video " src="https://www.youtube.com/embed/HdX7wSB4XcE?si=DOW-YDcxoaqB6YgM"></iframe>
          </div>
            </div>
            ...
            <div className='flex-1 flex   flex-col md:ml-[120px] ml-0 md:mt-[110px] mt-5 relative'>
              <div className="md:flex flex-row   w-full">
                <h1 className="flex  font-poppins font-[900] md:text-[40px] text-[27px] text-black md:leading-[48px] leading-[38px]">
                Multilinks Creation  <br className="sm:block hidden" />
       ...
       <div className='bg-[#F4FBFF] sm:px-16 px-6 flex justify-center items-start' >
        <div className='xl:max-w-[1280px] w-full'>
          ...
          <section className='flex md:flex-row flex-col sm:py-16 py-6'>
            ...
            <div className='flex-1 flex justify-center items-center'>
            <div className="flex justify-center mt-8" >
            <iframe className="lg:w-[50vw] w-[80vw] h-full aspect-video " src="https://www.youtube.com/embed/G8B35pTAtPo?si=R-gBfhFLkh-Gzo80"></iframe>
          </div>
            </div>
          </section>
