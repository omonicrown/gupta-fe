...
export default function CardTiered() {
  return (
    <>
        ...
        <div className="rounded-t mb-0  py-3 border-0">
          <div className="flex flex-wrap items-center">
            <div className="w-full px-4 max-w-full p-52 flex-grow flex-1">
              ...
              <h3 className="flex justify-center text-sm font-bold" > Tiered Links are only available on our Pro Plans</h3>
              <p className="flex text-sm justify-center" >Click on the button to subscribe to a plan </p>
