        ...
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          >
            ...
            <ul className="flex-col list-none flex bg-[#0071BC]  md:mt-1 mt-2">
              ...
              {/* <span className="items-center mx-3 mb-3 pl-5 mt-4 text-[11px] text-[#f8f8f862] uppercase">Coming Soon</span>

              <li className="items-center mx-3 mb-3 mt-3">
                <NavLink
                  onClick={() => setCollapseShow("hidden")}
                  to="/chatrouting"
                  className="text-[14px] pl-5 py-2.5 text-white/[0.56]"
                >Automation</NavLink>
